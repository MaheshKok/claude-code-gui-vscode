  ...
  describe("validateUrl", () => {
    ...
    it("should warn about localhost/internal IPs", () => {
      ...
      for (const url of internalUrls) {
        ...
        expect(result.valid).toBe(true);
        expect(result.warnings).toContain(
          "URL points to a local or internal address",
        );
      }
    });
  });
  ...
  describe("validateJsonSchema", () => {
    describe("object validation", () => {
      ...
      it("should validate required properties", () => {
        ...
        expect(
          validateJsonSchema({ name: "John", age: 30 }, schema).valid,
        ).toBe(true);
    ...
    describe("primitive validation", () => {
      it("should validate string type", () => {
        expect(validateJsonSchema("hello", { type: "string" }).valid).toBe(
          true,
        );
      ...
      it("should validate boolean type", () => {
        ...
        expect(validateJsonSchema("true", { type: "boolean" }).valid).toBe(
          false,
        );
      });
    });
