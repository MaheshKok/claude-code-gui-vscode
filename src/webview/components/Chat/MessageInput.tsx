...
const MODELS = [
  ...
  { id: 'claude-opus-4-5-20251101', name: 'Claude Opus 4.5', shortName: 'Opus 4.5' },
  { id: 'claude-haiku-4-5-20251001', name: 'Claude Haiku 4.5', shortName: 'Haiku 4.5' },
];
    ...
    <div className="border-t border-[var(--vscode-panel-border)] bg-[var(--vscode-sideBar-background)]">
              ...
              {MODELS.map((model) => (
                <button
                  ...
                  className={`w-full text-left px-3 py-1.5 text-sm hover:bg-[var(--vscode-list-hoverBackground)] ${
                    currentModel === model.id ? 'bg-[var(--vscode-list-activeSelectionBackground)]' : ''
                  }`}
                >
                  {model.name}
                </button>
      ...
      <div className="flex items-end gap-2 p-3">
        <textarea
          ...
          disabled={disabled}
          placeholder={disabled ? 'Claude is thinking...' : 'Type your message... (Shift+Enter for new line)'}
