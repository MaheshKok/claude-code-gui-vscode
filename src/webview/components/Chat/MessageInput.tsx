      ...
      <div className="flex items-center justify-between px-3 py-2 bg-black/20 border-t border-white/5 rounded-b-2xl">
        <div className="flex items-center gap-1">
          ...
          <div className="relative" ref={modelSelectorRef}>
            ...
            {showModelSelector && (
              <div className="absolute bottom-full left-0 mb-2 py-1 glass-panel rounded-xl shadow-xl z-50 min-w-[180px] overflow-hidden">
                {MODELS.map((model) => (
                  <button
                    key={model.id}
          ...
          <div className="relative" ref={thinkingSelectorRef}>
            ...
            {showThinkingSelector && (
              <div className="absolute bottom-full left-0 mb-2 p-1 glass-panel rounded-xl shadow-xl z-50 min-w-[240px]">
