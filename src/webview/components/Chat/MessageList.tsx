...
export const MessageList: React.FC<MessageListProps> = memo(
    ({ messages, isProcessing, showEmptyState = true, isScrollable = true }) => {
        ...
        const containerClasses = useMemo(
            () =>
                isScrollable ? "flex-1 overflow-y-auto px-4 py-4 space-y-4" : "px-4 py-4 space-y-4",
            [isScrollable],
        );
            ...
            return (
                <div className="flex flex-col items-center justify-center flex-1 p-8 text-center">
                    ...
                    <p className="text-sm text-[var(--vscode-descriptionForeground)] max-w-md">
                        Ask Claude anything about your code, get help with debugging, or request
                        code generation. Use slash commands for quick actions.
                    </p>
