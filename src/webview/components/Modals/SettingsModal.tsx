            ...
            <div className="space-y-6">
                ...
                <section>
                    ...
                    <p className="text-xs text-[var(--vscode-descriptionForeground)] mb-4">
                        WSL integration allows you to run Claude Code from within Windows Subsystem
                        for Linux.
                    </p>
                ...
                <section>
                    ...
                    <p className="text-xs text-[var(--vscode-descriptionForeground)] mb-4">
                        Manage commands and tools that are automatically allowed without asking for
                        permission.
                    </p>
                ...
                <section>
                    ...
                    <p className="text-xs text-[var(--vscode-descriptionForeground)] mb-4">
                        Configure default thinking intensity. Higher levels provide more detailed
                    ...
                    <div className="space-y-2">
                        <input
                            ...
                            style={{
                                ...
                                }%, var(--vscode-input-background) ${(settings.thinkingIntensity / 3) * 100}%)`,
                            }}
                        />
