...
window.onerror = function(message, source, lineno, colno, error) {
  console.error('[Webview] Global error:', { message, source, lineno, colno, error });
...
if (typeof window.acquireVsCodeApi === 'function' && !window.vscode) {
  try {
    ...
    console.log('[Webview] postMessage available:', typeof window.vscode?.postMessage === 'function');
  } catch (error) {
