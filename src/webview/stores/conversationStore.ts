 ...
 */
export const selectConversations = (state: ConversationStore) =>
  state.conversations;

/**
 * Select current conversation
 */
export const selectCurrentConversation = (state: ConversationStore) =>
  state.currentConversation;
 ...
 */
export const selectConversationCount = (state: ConversationStore) =>
