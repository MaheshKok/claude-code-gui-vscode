 ...
 */
export const selectPendingPermissions = (state: PermissionStore) =>
  state.pendingPermissions;

/**
 * Select allowed permissions
 */
export const selectAllowedPermissions = (state: PermissionStore) =>
  state.allowedPermissions;

/**
 * Select denied patterns
 */
export const selectDeniedPatterns = (state: PermissionStore) =>
  state.deniedPatterns;
